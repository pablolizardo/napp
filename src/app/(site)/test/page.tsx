...
export default function AuthenticationPage() {
    return (
        <>
            <div className="rounded-lg overflow-hidden relative  min-h-[calc(100vh_-_110px)]  flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
